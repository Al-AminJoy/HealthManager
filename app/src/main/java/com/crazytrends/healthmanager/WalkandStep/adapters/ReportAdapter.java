...
package com.crazytrends.healthmanager.WalkandStep.adapters;
...
import com.crazytrends.healthmanager.WalkandStep.models.ActivityChart;
import com.crazytrends.healthmanager.WalkandStep.models.ActivityChartDataSet;
import com.crazytrends.healthmanager.WalkandStep.models.ActivityDayChart;
import com.crazytrends.healthmanager.WalkandStep.models.ActivitySummary;
import com.crazytrends.healthmanager.WalkandStep.utils.UnitHelper;
        ...
        switch (getItemViewType(position)) {
            case TYPE_CHART:
                ...
                if (barChartXValues.size() > 0 && barChartData.getDisplayedDataType() == ActivityDayChart.DataType.STEPS) {
                    ...
                    chartLineDataSet.setDrawCircles(false);
                    chartLineDataSet.setColor(ContextCompat.getColor(barChartViewHolder.context, R.color.base_color), 200);
                    chartLineDataSet.setDrawValues(false);
                    lineDataSets.add(chartLineDataSet);
                }
                ...
                barDataSet.setColor(ContextCompat.getColor(barChartViewHolder.context, R.color.base_color));
            ...
            case TYPE_DAY_CHART:
                ...
                if (chartData.getDisplayedDataType() == null) {
                    ...
                    switch (chartData.getDisplayedDataType()) {
                        ...
                        default:
                            dataMap = chartData.getSteps();
                            label = chartViewHolder.context.getString(R.string.steps);
                            legendValues.put(ContextCompat.getColor(chartViewHolder.itemView.getContext(), R.color.base_color), chartViewHolder.context.getString(R.string.activity_summary_chart_legend_stepgoal));
                            break;
                    }
                }
                legendValues.put(ContextCompat.getColor(chartViewHolder.itemView.getContext(), R.color.base_color), label);
                ...
                if (chartXValues.size() > 0 && chartData.getDisplayedDataType() == ActivityDayChart.DataType.STEPS) {
                    ...
                    chartLineDataSet.setLineWidth(1);
                    chartLineDataSet.setDrawCircles(false);
                    chartLineDataSet.setColor(ContextCompat.getColor(chartViewHolder.context, R.color.base_color), 200);
                    chartLineDataSet.setDrawValues(false);
...
//            legend.setCustom(new ArrayList<>(legendValues.keySet()), new ArrayList<>(legendValues.values()));
    ...
    private LineDataSet getNewChartLineDataSet(Context context, String label){
        ...
        chartLineDataSet.setColor(ContextCompat.getColor(context, R.color.base_color), 200);
        chartLineDataSet.setCircleColor(ContextCompat.getColor(context, R.color.base_color));
        chartLineDataSet.setDrawValues(false);
